...
@include('partials.breadcamp', [
    'bcTitle' => 'Contact Us',
    'bcBg' => asset('assets/glowify/images/breadcamp_bg_7.jpeg'),
...
<div class="container">
        ...
        <div class="row align-items-center cs_gap_y_40">
            ...
            <div class="col-lg-6">
                <div class="cs_contact_form_wrap">
                    ...
                    <p class="cs_light">Have a question or need assistance? Fill out the form below and our team will get back to you as soon as possible — usually within 2 hours.</p>
            ...
            <div class="col-xl-5 col-lg-6 offset-xl-1">
                <div class="cs_contact_info cs_radius_8 cs_accent_bg">
                    ...
                    <p class="cs_white_color cs_light">For immediate assistance, reach us directly:</p>
                    ...
                    <div class="cs_contact_info_item">
                        ...
                        <div class="cs_contact_info_right">
                            <h4 class="cs_fs_16 cs_semibold cs_white_color cs_secondary_font">Phone (24/7)</h4>
                            <a href="tel:{{ preg_replace('/\s+/', '', setting('contact.phone', '+919876543210')) }}" class="cs_light cs_white_color">
                                {{ setting('contact.phone', '+91 98765 43210') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="cs_contact_info_item">
                        ...
                        <div class="cs_contact_info_right">
                            <h4 class="cs_fs_16 cs_semibold cs_white_color cs_secondary_font">Head Office</h4>
                            <span class="cs_light cs_white_color d-block">
                                {{ setting('contact.address', 'A-45, Health Tower, Mumbai 400001') }}
                            </span>
    ...
    <div class="cs_map cs_radius_10 overflow-hidden">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.11281381823!2d72.7104273614083!3d19.082502457710602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000"
