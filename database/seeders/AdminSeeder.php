...
class AdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaults = [
            ...
            ['key' => 'contact_phone',          'value' => '+91 98765 43210',                  'group' => 'general',  'type' => 'string'],
            ['key' => 'shipping_flat_rate',     'value' => '49',                               'group' => 'shipping', 'type' => 'integer'],
            ['key' => 'free_shipping_threshold','value' => '500',                              'group' => 'shipping', 'type' => 'integer'],
            ['key' => 'tax_rate',               'value' => '18',                               'group' => 'tax',      'type' => 'integer'],
            ...
            ['key' => 'razorpay_enabled',       'value' => '1',                               'group' => 'payment',  'type' => 'boolean'],
            ['key' => 'stripe_enabled',         'value' => '1',                               'group' => 'payment',  'type' => 'boolean'],
            ['key' => 'paypal_enabled',         'value' => '1',                               'group' => 'payment',  'type' => 'boolean'],
            ['key' => 'cod_enabled',            'value' => '1',                               'group' => 'payment',  'type' => 'boolean'],
            ['key' => 'wallet_enabled',         'value' => '1',                               'group' => 'payment',  'type' => 'boolean'],
        ];
